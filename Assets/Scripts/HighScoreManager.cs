...
public class HighScoreManager : MonoBehaviour
{
    ...
    public void SaveHighScore(string name, string time, int coins, int score)
    {
        ...
        while (i <= LeaderboardLength && PlayerPrefs.HasKey("HighScore" + i + "score"))
        {
            ...
            temp.coins = PlayerPrefs.GetInt("HighScore" + i + "coins");
        ...
        while (i <= LeaderboardLength && i <= HighScores.Count)
        {
            ...
            PlayerPrefs.SetInt("HighScore" + i + "coins", HighScores[i - 1].coins);
    ...
    public void ClearLeaderBoard()
    {
        ...
        for (int i = 1; i <= HighScores.Count; i++)
        {
            ...
            PlayerPrefs.DeleteKey("HighScore" + i + "coins");
